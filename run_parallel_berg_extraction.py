...
berg_nwbs = berg_path.glob('*.nwb')


if __name__ == '__main__':
    print(f'Starting processing at: {start_time}')
    result = Parallel(n_jobs=12)(delayed(generated_formatted_features_output)(str(nwb)) for nwb in berg_nwbs)
    ...
    feature_df.to_csv('ephys_features_berg_w_QC.csv')
